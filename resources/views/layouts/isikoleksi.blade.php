...
<div class="container">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav ms-auto"> 
      <li class="nav-item">
        <div data-aos="zoom-out-down">
        <a class="nav-link {{ ($title === 'Prasejarah') ? 'active' : ''  }}" aria-current="page" href="/prasejarah">Prasejarah</a>
      </li>
      <li class="nav-item">
         <div data-aos="zoom-out-down">
        <a class="nav-link {{ ($title === 'Hindu-Budha') ? 'active' : ''  }}" href="/hindu-budha">Hindu-budha</a>
      </li>
      <li class="nav-item">
         <div data-aos="zoom-out-down">
        <a class="nav-link {{ ($title === 'Islam') ? 'active' : ''  }}" href="/islam">Islam</a>
      </li>
       <li class="nav-item">
          <div data-aos="zoom-out-down">
        <a class="nav-link {{ ($title === 'Kolonial') ? 'active' : ''  }}" href="/kolonial">Kolonial</a>
      </li>  
    </ul>
</div>
</div>
